...
Future<Uint8List> serviceReport(List<ServiceModel> report1,
...
subTexts: [],
    ...
    build: (context) {
      ...
      GroupDetails(
          ...
          ...<ReportHelperModel>[
      ReportHelperModel(
      text:s.value.serviceNumber!.text ,
      fontSize: 12,
      fontColor: PdfColors.black,
      isCenter: true,
      columnSize: 1,
      ...
      ReportHelperModel(
      text:s.value.serviceName!.getTitle ,
      fontSize: 12,
      fontColor: PdfColors.black,
      isCenter: true,
      columnSize: 3,
      ...
      ReportHelperModel(
      text:s.value.serviceDescription!.getTitle ,
      fontSize: 12,
      fontColor: PdfColors.black,
      isCenter: true,
      columnSize: 3,
     ...
     ReportHelperModel(
       text:s.value.serviceHasStaticValue! ? s.value.servicePrice!.text :"unSelelected".tr(),
      fontSize: 12,
      fontColor: PdfColors.black,
      isCenter: true,
      columnSize: 2,
